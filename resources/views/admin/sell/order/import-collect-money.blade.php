...
@section('title') Admin | Import thu tiền từ excel (Marketing) @stop
{{-- Breadcrumb --}}
@section('breadcrumb')
    @php
        $breadcrumb = [
...
@section('assets')
    ...
    <script>
        let importExcelUrl = "{{ route('admin.sell.order.importExcelCollectMoney.post') }}"
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-3">
                                        <a target="_blank" href="{{asset('theme/admin-lte/dist/file/order_import_excel_collect_money.xlsx')}}"
