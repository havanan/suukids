...
@section('assets')
    ...
    <script>
        let storeUrl = "{{route('admin.profile.permission.store')}}"
...
@section('content')
    <section class="content">
        <div class="container">
            ...
            <form id="create-form" action="{{route('admin.profile.permission.create')}}" method="post" class="row">
                @csrf
                <div class="col-md-5">
                    <div class="card">
                        <div class="card-body">
                                ...
                                @foreach(PERMISSIONS_TITLE as $key => $value)
                                    <div class="col-md-6">
                                        <div class="custom-control custom-checkbox">
                                            <input class="custom-control-input" type="checkbox" name="{{$key}}" id="checkbox_{{$key}}" value="{{$key}}">
