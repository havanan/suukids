...
@section('breadcrumb')
    @php
        $breadcrumb = [
        'title' => __('Cấu hình Viettel Post'),
        ];
    @endphp
...
@section('content')
    <section class="content">
        <div class="container">
            <form method="post" action="{{ route('admin.config.vtpost.save') }}" enctype="multipart/form-data">
            @csrf
            <!-- /.row -->
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header card-header-default">
                                <h3 class="card-title">
                                    Cấu hình tài khoản Viettel Post
                                </h3>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="form-group col-md-5">
                                        ...
                                        <input type="text" name="vtpost_username" class="form-control" value="{{ $data['vtpost_username'] }}">
                                    </div>
                                    <div class="form-group col-md-5">
                                        <label>Password</label>
                                        <input type="password" name="vtpost_password" class="form-control" value="{{ $data['vtpost_password'] }}">
                                    </div>
                                </div>
                            </div>
                        </div>
