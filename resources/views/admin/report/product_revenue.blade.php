...
@section('title') Admin | BÁO CÁO DOANH THU SẢN PHẨM/HÀNG HÓA @stop
{{-- Breadcrumb --}}
@section('breadcrumb')
    @php
        $breadcrumb = [
        'title' => __('BÁO CÁO DOANH THU SẢN PHẨM/HÀNG HÓA'),
        'content' => [
        __('BÁO CÁO DOANH THU SẢN PHẨM/HÀNG HÓA') => ''
        ],
        'active' => [__('BÁO CÁO DOANH THU SẢN PHẨM/HÀNG HÓA')]
        ];
    @endphp
                                    ...
                                    <table width="100%" border="0">
                                        ...
                                        <tr>
                                            ...
                                            <th width="40%" style="text-align: center;">
                                                <h2>BÁO CÁO DOANH THU SẢN PHẨM/HÀNG HÓA</h2>
                                ...
                                <div class="col-md-12">
                                    <table class="table table-bordered" width="100%" border="1" cellspacing="0" cellpadding="2" style="border-collapse:collapse" bordercolor="#999">
                                        ...
                                        <tr>
                                            ...
                                            <th width="10%" scope="col" style="text-align: center;">Tổng tiền</th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        <?php
                                        ...
                                        <tr>
                                            ...
                                            <td align="center"><strong>{{number_format($price)}}</strong></td>
                                        </tr>
                                        </tbody></table>
                                </div>
                                @else
