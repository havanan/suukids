...
@section('breadcrumb')
    @php
        $breadcrumb = [
            ...
            'content' => [
                __('Quản lý xuất kho') => route('admin.stock.stock_out_list')
            ],
...
@section('assets')
<script>
  var urlDelete = "{{ route('admin.stock_out.delete') }}";
</script>
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="text-center" style="float: right">
                              <a href="{{route('admin.stock.stock_out_import')}}"><button class="btn btn-info">Thêm phiếu</button></a>
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                          <form action="{{route('admin.stock.stock_out_list')}}" method="post">
                            @csrf
                            <div class="row">
                              ...
                              <div class="form-group col-md-2">
                                <label>Từ ngày:</label>
                                <input name="create_date_from" id="create_date_from" class="form-control w-90 datepicker" type="text" 
                                        value="{{isset($dataSearch['create_date_from']) ? $dataSearch['create_date_from'] : ''}}">
                              </div>
                              <div class="form-group col-md-2">
                              ...
                              <tbody>
                                ...
                                @foreach ($stockOut as $index => $item)
                                  ...
                                  <tr>
                                    ...
                                    <td><a href="{{route('admin.stock.stock_out.view',$item->id)}}"><button type="button" class="btn btn-block bg-gradient-secondary">Xem</button></a></td>
                                    <td nowrap="nowrap"><a href="{{route('admin.stock.stock_out_edit',$item->id)}}"><button type="button" class="btn btn-block btn-warning">Sửa</button></a></td>
                                  </tr>
                                @endforeach
